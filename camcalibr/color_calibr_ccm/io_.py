...
def get_illuminant():
    ...
    illuminants[D65_2] = np.array([0.95047, 1.0, 1.08883])
    illuminants[D65_10] = np.array([0.94811, 1.0, 1.07304])
    return illuminants
...
class CAM:
    ...
    Von_Kries = np.array([[0.40024, 0.7076, -0.08081], [-0.2263, 1.16532, 0.0457], [0.0, 0.0, 0.91822]])
